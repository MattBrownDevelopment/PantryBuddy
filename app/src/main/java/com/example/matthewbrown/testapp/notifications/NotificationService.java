package com.example.matthewbrown.testapp.notifications;
...
import com.example.matthewbrown.testapp.test.R;
...
public class NotificationService extends Service implements LocationListener {
    ...
    public void onLocationChanged(final Location loc) {
        if(isBetterLocation(loc, previousBestLocation)) {
            ...
            com.backgroundservice.mkr.backgroundservice.notifications.GetNearbyPlacesData getNearbyPlacesData = new GetNearbyPlacesData();
